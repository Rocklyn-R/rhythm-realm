    ...
    return (
        <div className="w-full flex flex-col items-center bg-gray-200 py-10">
            <div className="w-2/3 flex flex-col items-center">
                <h1 className="text-4xl text-red-800 font-bold mb-10">Why Shop at Rhythm Realm?</h1>
            ...
            <div className='py-6 mt-10 w-2/3 border border-gray-300 rounded-md bg-white flex items-center justify-evenly'>
                <h4 className='font-semibold text-lg'>Expert Advice: Get personalized recommendations</h4>
                <div className='text-red-800 flex border-2 border-red-800 items-center px-4 py-1 rounded-md'>
